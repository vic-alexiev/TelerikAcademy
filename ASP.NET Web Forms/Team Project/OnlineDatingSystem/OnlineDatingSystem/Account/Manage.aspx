<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="OnlineDatingSystem.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
   <hgroup class="title">
    ...
    <div class="row-fluid">
        ...
        <div class="span6">
            <%--<asp:LinkButton runat="server" CssClass="ViewProfileButton" 
                Text="View Profile" 
                CommandName="ViewProfileCommand" 
                OnCommand="">
            </asp:LinkButton>--%>
            <a href='../UserDetails.aspx?id=<%= User.Identity.GetUserId() %>'>View Profile</a>
        </div>
    </div>
</asp:Content>
