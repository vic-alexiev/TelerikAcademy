...
namespace PokerUnitTests
{
    ...
    public class CardTests
    {
        ...
        public void TestCardToString1()
        {
            ...
            Assert.AreEqual("7♦", card.ToString(), "Card.ToString() is not correct.");
        }
        ...
        public void TestCardToString2()
        {
            ...
            Assert.AreEqual("A♥", card.ToString(), "Card.ToString() is not correct.");
        }
        ...
        public void TestCardToString3()
        {
            ...
            Assert.AreEqual("2♣", card.ToString(), "Card.ToString() is not correct.");
        }
        ...
        public void TestCardToString4()
        {
            ...
            Assert.AreEqual("Q♠", card.ToString(), "Card.ToString() is not correct.");
        }
        ...
        public void TestCardToString5()
        {
            ...
            Assert.AreEqual("10♠", card.ToString(), "Card.ToString() is not correct.");
        }
    }
}
