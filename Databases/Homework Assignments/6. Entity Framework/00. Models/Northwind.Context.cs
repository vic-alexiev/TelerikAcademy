...
namespace NorthwindModels
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<SupplierIncomeByYear_Result> SupplierIncomeByYear(string supplierContactName, Nullable<System.DateTime> beginningDate, Nullable<System.DateTime> endingDate)
        {
            ...
            var beginningDateParameter = beginningDate.HasValue ?
                new ObjectParameter("BeginningDate", beginningDate) :
                new ObjectParameter("BeginningDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SupplierIncomeByYear_Result>("SupplierIncomeByYear", supplierContactNameParameter, beginningDateParameter, endingDateParameter);
        }
    }
}
