...
namespace AcademyRPGForBGCoder
{
    ...
    public class Engine
    {
        ...
        public void ExecuteCommand(string command)
        {
            ...
            {
                this.ExecuteCreateObjectCommand(commandWords, 2);
            }
            else
            {
        ...
        public virtual void ExecuteCreateObjectCommand(string[] commandWords, int i)
        {
    ...
    {
        public override void ExecuteCreateObjectCommand(string[] commandWords, int i)
        {
            base.ExecuteCreateObjectCommand(commandWords, 2);
